	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Inicio</span></a>
			</li>
			...
			<li class="nav-item"><a class="nav-link" href="index.html">
					<i class="fas fa-user"></i> <span>Usuarios/as</span>
			</a></li>
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item"><a class="nav-link" href="index.html">
					<i class="fas fa-horse"></i> <span>Animales</span>
			</a></li>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Usuarios/as</h1>
					</div>
											...
											<tbody>
												<tr>
													...
													<td><a href="#"><i
														...
														href="#modalEliminar" data-id="${usuario.id}"
