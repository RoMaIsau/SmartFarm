...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Enfermedades en 2020</h1>
	...
	<script>
		...
		var barChartData = {
			labels : [ 'Leptospirosis', '', 'Miocardiopatia', '', '', '',
					'Diciembre' ],
			datasets : [
					{
						label : 'Mayo',
						...
						borderColor : '#FFD57E',
						borderWidth : 1,
						data : [ <c:forEach items="${mayo}" var="casos">
						${casos.value},
						</c:forEach> ]
					},
					{
						...
						borderColor : '#AD84C7',
						borderWidth : 1,
						data : [ <c:forEach items="${junio}" var="gastos">
						${gastos.value},
						</c:forEach> ]
					},
					{
						...
						borderColor : '#89C7B6',
						borderWidth : 1,
						data : [ <c:forEach items="${enfermedades}" var="gastos">
						${gastos.value},
						</c:forEach> ]
					},
					{
						...
						borderColor : '#7998C9',
						borderWidth : 1,
						data : [ <c:forEach items="${agosto}" var="gastos">
						${gastos.value},
						</c:forEach> ]
					},
					]
