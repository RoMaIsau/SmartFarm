									...
									<div class="col-lg-12">
										<div class="p-5">
											<div class="text-center">
												<h1 class="h4 text-gray-900 mb-4">Editar Animal</h1>
											</div>
											<form:form action="editar" method="post" modelAttribute="animalEditable">
												<div class="row">
													<div class="col-sm-6">
												...
												<form:button class="btn btn-primary btn-user btn-block text-white">Editar</form:button>
											</form:form>
										</div>
									</div>
								</div>
